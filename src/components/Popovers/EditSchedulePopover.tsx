			...
			<Popover.Portal>
				...
				>
					...
					>
						...
						<fieldset className="Fieldset flex flex-col gap-5 items-center">
							...
							<ul className="flex flex-col gap-2 w-full">
								{data.users.sharingWith.map(({ userEmail, permissions }) => (
									...
									>
										<input
											className="Input w-full inline-flex items-center justify-center flex-1 rounded-sm px-2 h-[35px]"
											id="sharedWith"
											...
											onBlur={e => {
												setData({
													...
													users: {
														...data.users,
														sharingWith: data.users.sharingWith.map(user => {
								...
								{data.users.sharingWith.length === 0 && (
									<li className="flex flex-row gap-2 items-center">
										<p className="text-gray-400">No sharees</p>
									</li>
								)}
							</ul>
